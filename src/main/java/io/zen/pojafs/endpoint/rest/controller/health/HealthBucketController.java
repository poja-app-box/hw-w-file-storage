package io.zen.pojafs.endpoint.rest.controller.health;

import static io.zen.pojafs.file.hash.FileHashAlgorithm.NONE;
import static java.io.File.createTempFile;
import static java.nio.file.Files.createTempDirectory;
import static java.util.UUID.randomUUID;

import io.zen.pojafs.PojaGenerated;
import io.zen.pojafs.file.bucket.BucketComponent;
import io.zen.pojafs.file.hash.FileHash;
import java.io.File;
